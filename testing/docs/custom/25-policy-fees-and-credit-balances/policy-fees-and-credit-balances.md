...
- **Migration numbering may have moved again.** This is the *second* time this epic's assumed "latest migration" needed correcting before work even started (the Guide's own note flagged this as likely). Reconfirm the actual latest file in `supabase/migrations/` before branching anything else on top of this batch.
