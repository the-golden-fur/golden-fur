---
name: commit
description: Write and create a conventional-commit-style git commit for the currently staged/unstaged changes. Use whenever asked to commit changes — this performs the actual commit, it does not just draft a message to paste.
---
...
Claude Code can discover and auto-invoke it.
