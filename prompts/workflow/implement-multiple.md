...
- issue range (e.g. 12-15, or a comma-separated list like 12,14,16):
...
- any terminal commands provided (e.g. git add) must work in the VSCode PowerShell terminal, whether formatted as a single line or multiple lines
...
- a suggested branch name for the request
